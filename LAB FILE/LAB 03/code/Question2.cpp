...
// Q2.Solve the following problem using a Singly Linked List. Given a singly linked list of
...
string dictionary[]={"hello","rehan","maha","ali","class","university","section","data","structure","algorithm","sir",
